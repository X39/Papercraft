...
Image attributes and source behavior are checked against `ImageControl`, `DefaultResourceResolver`,
...
It is generated by `ImageDocumentationSamples.Image_FromTemplateData`.
