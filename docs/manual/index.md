...
The manual structure is now in place, and the first document, template data, layout, styles, template-language, text-control, border-control, image-control, line-control, page-number-control and table-control chapters have verified starter examples.
