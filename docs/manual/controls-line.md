...
`BasicDocumentationSamples.Line_HorizontalSeparator` and `LineDocumentationSamples.Line_VerticalDivider`.
...
This sample is generated by `LineDocumentationSamples.Line_VerticalDivider`.
