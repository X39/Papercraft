...
This sample is generated by `TextDocumentationSamples.Text_FontSizeAndColor`.
...
This sample is generated by `TextDocumentationSamples.Text_Alignment`.
...
This sample is generated by `TextDocumentationSamples.Text_Padding`.
...
Named weights such as `thin`, `normal`, `semiBold`, `bold`, `extraBold` and `black` are verified by
`TextSample.NamedFontWeights`.

This sample is generated by `TextDocumentationSamples.Text_StyleAndWeight`.
...
- Expecting underline to work as a text attribute; underline is not verified on the built-in text control.
