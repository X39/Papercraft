...
Status: started. The invoice, report, product sheet and chart dashboard previews on this page are verified by
...
This sample is generated by `CompleteExampleDocumentationSamples.CompleteExample_ChartDashboardPreview`.
