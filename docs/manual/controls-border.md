...
This sample is generated by `BasicDocumentationSamples.Border_WithBackground`.
...
This sample is generated by `BorderDocumentationSamples.Border_BottomRule`.
...
`BorderControlTests.CanAddAllowsAnyControlType` verifies that it accepts `text`, another `border`
and custom controls.
