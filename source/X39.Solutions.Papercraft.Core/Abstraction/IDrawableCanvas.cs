...
public interface IDrawableCanvas
{
    ...
    /// <summary>
    ///     Draws encoded image bytes on the canvas.
    /// </summary>
    /// <param name="image">The encoded image bytes to draw.</param>
    /// <param name="rectangle">The region to draw the image into.</param>
    void DrawImage(byte[] image, Rectangle rectangle)
        => DrawBitmap(image, rectangle);
    ...
    /// <param name="image">The encoded image bytes to draw.</param>
    /// <param name="rectangle">The region to draw the image into.</param>
    void DrawImage(ReadOnlyMemory<byte> image, Rectangle rectangle)
