...
public sealed class ControlRegistry
{
        ...
        foreach (var registration in registrations)
        {
            ...
            if (_controls.TryGetValue(key, out var existingType))
                throw new InvalidOperationException(
                    $"The control {registration.Namespace}:{registration.Name} is registered more than once. Existing type: {existingType.FullName()}.");
    ...
    public static ControlRegistration CreateRegistration<
        [MeansImplicitUse(
