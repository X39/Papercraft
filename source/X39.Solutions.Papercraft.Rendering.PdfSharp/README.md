...
After registration, resolve `PapercraftRenderer` from the service provider and render with `PapercraftRenderOptions.BackendId = "pdfsharp"` when multiple PDF-capable backends are registered.
