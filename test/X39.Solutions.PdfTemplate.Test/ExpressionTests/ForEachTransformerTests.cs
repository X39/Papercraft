...
public class ForEachTransformerTests
{
    ...
    public async Task ForEachLoopWithVariableSourceAndIndex()
    {
        ...
        var templateReader = new XmlTemplateReader(default, CultureInfo.InvariantCulture, data, new[] {new global::X39.Solutions.Papercraft.Transformers.ForEachTransformer()});
